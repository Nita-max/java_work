class Course {
    ...
    Course(String c, String i, double d) {
        System.out.println("Parameterized Course constructor called");
        this.courseName = c;
        this.instructor = i;
        this.duration = d;
    }
...
class OnlineCourse extends Course {
    ...
    OnlineCourse() {
        super();
        System.out.println("Default OnlineCourse constructor called");
        this.platform = "Udemy";
    ...
    OnlineCourse(String c, String i, double d, String p, boolean cert, double f) {
        super(c, i, d);
        System.out.println("Parameterized OnlineCourse constructor called");
        this.platform = p;
...
class OfflineCourse extends Course {
    ...
    OfflineCourse() {
        super();
        System.out.println("Default OfflineCourse constructor called");
    ...
    OfflineCourse(String c, String i, double d, String l, int s, boolean lab) {
        super(c, i, d);
        System.out.println("Parameterized OfflineCourse constructor called");
        this.location = l;
        this.students = s;
        this.hasLab = lab;
    }
...
class Workshop extends Course {
    ...
    Workshop() {
        super();
        System.out.println("Default Workshop constructor called");
        this.days = 2;
    ...
    Workshop(String c, String i, double d, int da, String t, String o) {
        super(c, i, d);
        System.out.println("Parameterized Workshop constructor called");
        this.days = da;
        this.topic = t;
        this.organizer = o;
    }
...
class TestCourse {
    public static void main(String[] args) {
        ...
        OnlineCourse oc = new OnlineCourse("Java Masterclass", "Neha", 40.0, "Coursera", true, 1200.0);
        oc.display();

        System.out.println("\n=================== Offline Course Details ===================");
        OfflineCourse ofc = new OfflineCourse("Data Science", "Amit", 60.0, "Pune Campus", 25, true);
        ofc.display();

        System.out.println("\n=================== Workshop Details ===================");
        Workshop w = new Workshop("AI Bootcamp", "Dr. Mehta", 15.0, 3, "Machine Learning", "TechX Institute");
        w.display();
    }
}
