...
class TestPerson {
    public static void main(String[] args) {
        ...
        System.out.println("\n=================== Student details ===================");
        Student s = new Student("Riya", 21, "Female", 102, "BSc", 89.4);
        s.display();

        System.out.println("\n=================== Teacher details ===================");
        Teacher t = new Teacher("Rajesh", 40, "Male", "Physics", 12, 60000);
        t.display();

        System.out.println("\n=================== Doctor details ===================");
        Doctor d = new Doctor("Sneha", 35, "Female", "Dentist", 15, 800);
        d.display();
    }
}
