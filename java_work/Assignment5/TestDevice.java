...
class TestDevice {
    public static void main(String[] args) {
        ...
        System.out.println("\n=================== Mobile details ===================");
        Mobile m = new Mobile("Samsung", "S24", 80000, 5000, "Android", 6.8);
        m.display();

        System.out.println("\n=================== Laptop details ===================");
        Laptop l = new Laptop("HP", "Pavilion", 65000, 16, "Intel i7", 1.3);
        l.display();

        System.out.println("\n=================== Tablet details ===================");
        Tablet t = new Tablet("Apple", "iPad Pro", 90000, true, 256, 6.4);
        t.display();
    }
}
