...
class TestProduct {
    public static void main(String[] args) {
        ...
        System.out.println("\n=================== Electronics Details ===================");
        p = new Electronics(301, "LED TV", 35000.0, "LG", 36, 120.0);
        p.display();

        System.out.println("\n=================== Furniture Details ===================");
        p = new Furniture(401, "Office Chair", 5000.0, "Plastic", "Chair", 8.5);
        p.display();

        System.out.println("\n=================== Grocery Details ===================");
        p = new Grocery(501, "Rice", 60.0, 10.0, "Food", "12-12-2026");
        p.display();
    }
}
