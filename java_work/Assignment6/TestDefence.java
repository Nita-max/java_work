...
class TestDefence {
    public static void main(String[] args) {
        ...
        System.out.println("\n=================== Army Details ===================");
        d = new Army("India", 1200000, 40000000000.0, "Armored", "General Rajput", 1000);
        d.display();

        System.out.println("\n=================== Navy Details ===================");
        d = new Navy("India", 70000, 20000000000.0, 150, "Visakhapatnam", "Admiral Mehta");
        d.display();

        System.out.println("\n=================== AirForce Details ===================");
        d = new AirForce("India", 150000, 25000000000.0, 250, "Bangalore Air Command", "Air Marshal Rana");
        d.display();
    }
}
