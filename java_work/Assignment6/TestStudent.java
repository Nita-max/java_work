...
class TestStudent {
    public static void main(String[] args) {
        ...
        s = new SchoolStudent(301, "Aman", "Matric", "Bright Future School", 9, 'B');
        s.display();

        System.out.println("\n=================== CollegeStudent details ===================");
        s = new CollegeStudent(401, "Sneha", "BCA", "SBES College", "Computer Science", 3);
        s.display();

        System.out.println("\n=================== ResearchStudent details ===================");
        s = new ResearchStudent(501, "Kunal", "PhD", "Machine Learning", "Dr. Patel", 4);
        s.display();
    }
}
