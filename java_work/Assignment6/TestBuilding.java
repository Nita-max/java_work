...
class TestBuilding {
    public static void main(String[] args)
   {
        ...
        System.out.println("\n=================== House details ===================");
        b = new House("Residential", 2, "Nashik", 5, "Yellow", true);
        b.display();

        System.out.println("\n=================== Office details ===================");
        b = new Office("Corporate", 6, "Mumbai", 120, "HR", true);
        b.display();

        System.out.println("\n=================== Apartment details ===================");
        b = new Apartment("Residential", 12, "Nagpur", 48, true, 2500.75);
        b.display();
    }
}
